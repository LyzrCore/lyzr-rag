...
from lyzr_rag.bridge.pydantic import BaseModel, PrivateAttr
...
from lyzr_rag.schema import BaseComponent
from lyzr_rag.types import PydanticProgramMode, TokenAsyncGen, TokenGen
...
class LLMPredictor(BaseLLMPredictor):
    ...
    def from_dict(cls, data: Dict[str, Any], **kwargs: Any) -> Self:  # type: ignore
        ...
        if llm != "default":
            from lyzr_rag.llms.loading import load_llm
    ...
    def _run_program(
        ...
        **prompt_args: Any,
        ...
        from lyzr_rag.program.utils import get_program_for_llm
