...
from lyzr_rag.bridge.pydantic import BaseModel  # type: ignore
...
from lyzr_rag.response_synthesizers.base import BaseSynthesizer, QueryTextType
from lyzr_rag.schema import MetadataMode, NodeWithScore, TextNode
from lyzr_rag.types import RESPONSE_TEXT_TYPE
from lyzr_rag.vector_stores.google.generativeai import google_service_context
...
class GoogleTextSynthesizer(BaseSynthesizer):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        """
        try:
            import lyzr_rag.vector_stores.google.generativeai.genai_extension as genaix
        except ImportError:
