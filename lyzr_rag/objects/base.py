...
from lyzr_rag.objects.base_node_mapping import (
    DEFAULT_PERSIST_FNAME,
    BaseObjectNodeMapping,
    SimpleObjectNodeMapping,
)
from lyzr_rag.schema import QueryType
from lyzr_rag.storage.storage_context import DEFAULT_PERSIST_DIR, StorageContext
...
class ObjectIndex(Generic[OT]):
    ...
    def from_persist_dir(
        ...
        from lyzr_rag.indices import load_index_from_storage
