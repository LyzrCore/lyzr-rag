...
from lyzr_rag.llms.cohere_utils import (
    CHAT_MODELS,
...
class Cohere(LLM):
    ...
    def __init__(
        ...
        self._client = cohere.Client(api_key, client_name="lyzr_rag")
        self._aclient = cohere.AsyncClient(api_key, client_name="lyzr_rag")
