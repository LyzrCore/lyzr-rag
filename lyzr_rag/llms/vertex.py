...
from lyzr_rag.llms.vertex_gemini_utils import is_gemini_model
from lyzr_rag.llms.vertex_utils import (
    CHAT_MODELS,
    CODE_CHAT_MODELS,
    CODE_MODELS,
    TEXT_MODELS,
...
class Vertex(LLM):
    ...
    def __init__(
        ...
        if model in CHAT_MODELS:
            ...
            from lyzr_rag.llms.vertex_gemini_utils import create_gemini_client
