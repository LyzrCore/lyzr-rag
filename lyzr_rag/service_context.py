...
from lyzr_rag.core.embeddings.base import BaseEmbedding
from lyzr_rag.indices.prompt_helper import PromptHelper
from lyzr_rag.llm_predictor import LLMPredictor
from lyzr_rag.llm_predictor.base import BaseLLMPredictor, LLMMetadata
from lyzr_rag.llms.llm import LLM
from lyzr_rag.llms.utils import LLMType, resolve_llm
from lyzr_rag.logger import LlamaLogger
from lyzr_rag.node_parser.interface import NodeParser, TextSplitter
from lyzr_rag.node_parser.text.sentence import (
    DEFAULT_CHUNK_SIZE,
    SENTENCE_CHUNK_OVERLAP,
    SentenceSplitter,
)
from lyzr_rag.prompts.base import BasePromptTemplate
from lyzr_rag.schema import TransformComponent
from lyzr_rag.types import PydanticProgramMode
...
class ServiceContext:
    ...
    def from_defaults(
        ...
        You can change the base defaults by setting lyzr_rag.global_service_context
        ...
        """
        from lyzr_rag.embeddings.utils import EmbedType, resolve_embed_model
        ...
        if lyzr_rag.global_service_context is not None:
            return cls.from_service_context(
                lyzr_rag.global_service_context,
                llm=llm,
    ...
    def from_dict(cls, data: dict) -> "ServiceContext":
        from lyzr_rag.embeddings.loading import load_embed_model
        from lyzr_rag.extractors.loading import load_extractor
        from lyzr_rag.llm_predictor.loading import load_predictor
        from lyzr_rag.node_parser.loading import load_parser
...
def set_global_service_context(service_context: Optional[ServiceContext]) -> None:
    ...
    lyzr_rag.global_service_context = service_context
