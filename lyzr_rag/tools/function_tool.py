...
if TYPE_CHECKING:
    from lyzr_rag.bridge.langchain import StructuredTool, Tool
from lyzr_rag.bridge.pydantic import BaseModel
from lyzr_rag.tools.types import AsyncBaseTool, ToolMetadata, ToolOutput
from lyzr_rag.tools.utils import create_schema_from_function
...
class FunctionTool(AsyncBaseTool):
    ...
    def to_langchain_tool(
        ...
        **langchain_tool_kwargs: Any,
        ...
        """To langchain tool."""
        from lyzr_rag.bridge.langchain import Tool
    ...
    def to_langchain_structured_tool(
        ...
        **langchain_tool_kwargs: Any,
        ...
        from lyzr_rag.bridge.langchain import StructuredTool
