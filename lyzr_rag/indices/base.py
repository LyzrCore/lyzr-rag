...
from lyzr_rag.chat_engine.types import BaseChatEngine, ChatMode
from lyzr_rag.core.base_query_engine import BaseQueryEngine
from lyzr_rag.core.base_retriever import BaseRetriever
from lyzr_rag.data_structs.data_structs import IndexStruct
from lyzr_rag.ingestion import run_transformations
from lyzr_rag.schema import BaseNode, Document, IndexNode
from lyzr_rag.service_context import ServiceContext
from lyzr_rag.storage.docstore.types import BaseDocumentStore, RefDocInfo
...
class BaseIndex(Generic[IS], ABC):
    ...
    def as_chat_engine(
        ...
        if chat_mode in [ChatMode.REACT, ChatMode.OPENAI, ChatMode.BEST]:
            ...
            # NOTE: lazy import
            from lyzr_rag.agent import AgentRunner
        ...
        if chat_mode == ChatMode.CONDENSE_QUESTION:
            # NOTE: lazy import
            from lyzr_rag.chat_engine import CondenseQuestionChatEngine
            ...
            from lyzr_rag.chat_engine import ContextChatEngine
            ...
            from lyzr_rag.chat_engine import CondensePlusContextChatEngine
            ...
            from lyzr_rag.chat_engine import SimpleChatEngine
