...
from lyzr_rag.data_structs.data_structs import IndexDict, MultiModelIndexDict
from lyzr_rag.embeddings.multi_modal_base import MultiModalEmbedding
from lyzr_rag.embeddings.utils import EmbedType, resolve_embed_model
from lyzr_rag.indices.utils import (
...
from lyzr_rag.schema import BaseNode, ImageNode
from lyzr_rag.service_context import ServiceContext
from lyzr_rag.storage.storage_context import StorageContext
from lyzr_rag.vector_stores.simple import DEFAULT_VECTOR_STORE, SimpleVectorStore
...
class MultiModalVectorStoreIndex(VectorStoreIndex):
    ...
    def as_retriever(self, **kwargs: Any) -> BaseRetriever:
        # NOTE: lazy import
        from lyzr_rag.indices.multi_modal.retriever import (
