...
class RocksetVectorStore(VectorStore):
    ...
    def __init__(
        ...
        Args:
            ...
            text_key (str): The key to the text of nodes
                (default: lyzr_rag.vector_stores.utils.DEFAULT_TEXT_KEY)
            embedding_col (str): The DB column containing embeddings
                (default: lyzr_rag.vector_stores.utils.DEFAULT_EMBEDDING_KEY))
        ...
        try:
            self.rs.set_application("lyzr_rag")
    ...
    def query(self, query: VectorStoreQuery, **kwargs: Any) -> VectorStoreQueryResult:
        ...
        Args:
            query (lyzr_rag.vector_stores.types.VectorStoreQuery): The query
            similarity_col (Optional[str]): The column to select the cosine
                similarity as (default: "_similarity")

        Returns:
            query results (lyzr_rag.vector_stores.types.VectorStoreQueryResult)
        """
