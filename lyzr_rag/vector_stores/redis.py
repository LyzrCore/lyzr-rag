...
from lyzr_rag.readers.redis.utils import (
    TokenEscaper,
    array_to_buffer,
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            index_prefix (str): Prefix for the index. Defaults to "lyzr_rag".
            ...
            prefix_ending (str): Prefix ending for the index. Be careful when
                changing this: https://github.com/jerryjliu/lyzr_rag/pull/6665.
                Defaults to "/vector".
