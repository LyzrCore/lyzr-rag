...
from lyzr_rag.finetuning.types import BaseCohereRerankerFinetuningEngine
from lyzr_rag.indices.postprocessor import CohereRerank
...
class CohereRerankerFinetuneEngine(BaseCohereRerankerFinetuningEngine):
    ...
    def __init__(
        ...
        self._model = cohere.Client(self.api_key, client_name="lyzr_rag")
