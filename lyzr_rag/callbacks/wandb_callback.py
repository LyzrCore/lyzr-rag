...
from lyzr_rag.callbacks.schema import (
    TIMESTAMP_FORMAT,
    CBEvent,
    CBEventType,
    EventPayload,
)
from lyzr_rag.callbacks.token_counting import get_llm_token_counts
...
class WandbCallbackHandler(BaseCallbackHandler):
    ...
    def _ensure_run(self, should_print_url: bool = False) -> None:
        ...
        if self._wandb.run is None:
            ...
            self._wandb.run._label(repo="lyzr_rag")  # type: ignore
