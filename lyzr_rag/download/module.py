...
from lyzr_rag.download.utils import (
    get_exports,
    get_file_content,
    ...
    if refresh_cache or not os.path.exists(module_path):
        ...
        if use_gpt_index_import:
            basepy_raw_content = basepy_raw_content.replace(
                "import lyzr_rag", "import lyzr_rag"
            )
            basepy_raw_content = basepy_raw_content.replace(
                "from lyzr_rag", "from lyzr_rag"
            )
...
def download_llama_module(
    ...
    Args:
        ...
        use_gpt_index_import: If true, the loader files will use
            lyzr_rag as the base dependency. By default (False),
            the loader files use lyzr_rag as the base dependency.
